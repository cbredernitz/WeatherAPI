...
public class WeatherReportControllerTest {
    ...
    @Test
    @DirtiesContext
    public void givenLocation_whenWeatherReportEndpointCalled_thenReturnAccurateSummary() throws Exception {
        WeatherReportLocationModel weatherReportLocationModel = new WeatherReportLocationModel();
        weatherReportLocationModel.setLatitude(80.89);
        weatherReportLocationModel.setLongitude(157.89);
        ...
        assertEquals(expectedWeather.getSummary(), objectMapper.readValue(result.getResponse().getContentAsString(), WeatherReportWeatherModel.class).getSummary());
    }
